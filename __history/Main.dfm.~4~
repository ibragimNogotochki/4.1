object MainForm: TMainForm
  ...
  object MainMenu1: TMainMenu
    ...
    object Funcs: TMenuItem
      Caption = #1060#1091#1085#1082#1094#1080#1080
      object AddRecs: TMenuItem
        Caption = #1044#1086#1073#1072#1074#1080#1090#1100' '#1079#1072#1087#1080#1089#1080
        OnClick = AddRecsClick
      end
      object CorrectRecs: TMenuItem
        Caption = #1057#1082#1086#1088#1088#1077#1082#1090#1080#1088#1086#1074#1072#1090#1100' '#1079#1072#1087#1080#1089#1080
      end
      object N5: TMenuItem
        Caption = '-'
      end
      object ViewRecs: TMenuItem
        Caption = #1055#1088#1086#1089#1084#1086#1088#1090#1077#1090#1100' '#1079#1072#1087#1080#1089#1080
        OnClick = ViewRecsClick
      end
      object N7: TMenuItem
        Caption = '-'
      end
      object DeleteRecs: TMenuItem
